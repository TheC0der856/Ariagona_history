...
stairway_plOtter <- function(species, color, title){
  ...
  plot <- ggplot(in.data, aes(x=year)) +
    ...
    geom_line(data=in.data, aes(y=Ne_median), colour = color, linetype='solid', size = 1.8) +
...
P_t_most_east <- lapply(pops[7], stairway_plOtter, color = "darkslategray", title = "Lagunetas and east Anaga")[[1]]
P_t_little_east <- lapply(pops[9], stairway_plOtter, color = "darkslategray4", title = "West Anaga")[[1]]
P_t_agua <- lapply(pops[8], stairway_plOtter, color = "darkslategray3", title = "Center")[[1]]
P_t_west <- lapply(pops[6], stairway_plOtter, color = "darkslategray1", title = "West")[[1]]

P_g_majona <- lapply(pops[3], stairway_plOtter, color = "darkolivegreen", title = "East")[[1]]
P_g_south <- lapply(pops[2], stairway_plOtter, color = "darkolivegreen3", title = "Center")[[1]]
P_g_north <- lapply(pops[1], stairway_plOtter, color = "darkolivegreen1", title = "North")[[1]]


P_h_east <- lapply(pops[5], stairway_plOtter, color = "gold3", title = "East")[[1]]
P_h_west <- lapply(pops[4], stairway_plOtter, color = "gold1", title = "West")[[1]]
